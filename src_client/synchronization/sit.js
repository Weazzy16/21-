...
class SitClass {
  constructor() {
    ...
    /*gm.events.add("render", () => {
            ...
            {
                callRemote("client_trycatch", "synchronization/sit", "render", e.toString());
            }
        });*/
  ...
  standUp() {
    try {
      if (this.isCanStandUp()) {
        ...
        if (this.currentObject) call("hud.oEnter", "Seating");
      }
    } catch (e) {
      callRemote(
        "client_trycatch",
