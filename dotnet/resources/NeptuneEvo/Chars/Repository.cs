        ...
        public static IReadOnlyDictionary<ItemId, ItemsInfo> ItemsInfo = new Dictionary<ItemId, ItemsInfo>()
{
    ...
    { ItemId.BagWithDrill, new ItemsInfo("Сумка с дрелью", "Используется для взлома хранилища.", "inv-item-Bag-drill", "Остальное", NAPI.Util.GetHashKey("prop_cs_heist_bag_02"), 1, new Vector3(0, 0, -0.85), new Vector3(), newItemType.None, "gray", 8.0f, 3, 3) },
    { ItemId.GasCan, new ItemsInfo("Канистра", "Можно заправить транспортное средство.", "inv-item-gasoline", "Инструменты", 786272259, 2, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.None, "gray", 3.0f, 3, 3) },
    ...
    { ItemId.Pistol50, new ItemsInfo("Штурмовой пистолет", "Стреляет патронами 9x19mm. Ударопрочный пистолет, который обеспечивает огромную мощность, но с чрезвычайно сильной отдачей. Держит 9 раундов в журнале.", "inv-item-Pistol-50", "Оружие", 4116483281, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.0f, 2, 1) },
    { ItemId.SNSPistol, new ItemsInfo("Карманный пистолет", "Стреляет патронами 9x19mm. Как презервативы или лаки для волос, это уместится в вашем кармане на ночь в городе.", "inv-item-SNS-Pistol", "Оружие", 339962010, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.4f, 1, 1) },
    { ItemId.HeavyPistol, new ItemsInfo("Тяжелый Пистолет", "Стреляет патронами калибра 9x19mm. Каждый раз обеспечивает точность и серьезную тренировку предплечья.", "inv-item-Heavy-Pistol", "Оружие", 1927398017, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.5f, 2, 1) },
    { ItemId.VintagePistol, new ItemsInfo("Винтажный пистолет", "Стреляет патронами калибра 9x19mm. Выделитесь из толпы при вооруженном ограблении с этим гравированным пистолетом.", "inv-item-Vintage-Pistol", "Оружие", 3170921020, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.5f, 2, 1) },
    { ItemId.MarksmanPistol, new ItemsInfo("Пистолет Marksman", "Стреляет патронами калибра .357 Magnum. Сделайте так, чтобы вы считали, что вы будете перезаряжать столько, сколько вы стреляете.", "inv-item-Marksman-Pistol", "Оружие", 4191177435, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.0f, 3, 1) },
    { ItemId.Revolver, new ItemsInfo("Револьвер", "Стреляет патронами калибра .357 Magnum. Пистолет с достаточной силой, позволяющей сбросить сумасшедшего носорога, если у вас нет патронов.", "inv-item-Heavy-Revolver", "Оружие", 914615883, 1, new Vector3(0.0,0.0,-0.95), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.0f, 2, 1) },
    { ItemId.APPistol, new ItemsInfo("Бронебойный пистолет", "Стреляет патронами 9x19mm. Высокопроникающий, полностью автоматический пистолет. Содержит 18 патронов.", "inv-item-AP-Pistol", "Оружие", 905830540, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.8f, 2, 1) },
    { ItemId.StunGun, new ItemsInfo("Электрошокер", "Электрошоковое оружие, обойма вмещает в себя 1 заряд.", "inv-item-Stun-Gun", "Оружие ближнего боя", 1609356763, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.5f, 2, 1) },
    { ItemId.FlareGun, new ItemsInfo("Сигнальный пистолет", "Сигнальный пистолет.", "inv-item-Flare-Gun", "Оружие", 1349014803, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.7f, 2, 1) },
    { ItemId.DoubleAction, new ItemsInfo("Наградной револьвер", "Стреляет патронами калибра .357 Magnum. Потому что иногда месть - это блюдо, которое лучше всего подавать шесть раз подряд, прямо между глаз. Уникальное оружие LSCSD", "inv-item-Double-Action-Revolver", "Оружие", 1393678102, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.5f, 2, 1) },
    { ItemId.PistolMk2, new ItemsInfo("Пистолет Mk2", "Стреляет патронами калибра 9x19mm. Ударопрочный пистолет, который обеспечивает огромную мощность, но с чрезвычайно сильной отдачей.", "inv-item-Pistol-Mk-II", "Оружие", 995074671, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.6f, 2, 1) },
    ...
    { ItemId.RevolverMk2, new ItemsInfo("Револьвер Mk2", "Стреляет патронами калибра .357 Magnum. Если вы можете поднять его, это будет самое близкое к тому, чтобы застрелить кого-то грузовым поездом.", "inv-item-Heavy-Revolver-Mk-II", "Оружие", 4065179617, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.5f, 2, 1) },
    { ItemId.RayPistol, new ItemsInfo("Рей питослетr", "Футуристичный пистолет, не требует боеприпасов.", "inv-item-Vintage-Pistol", "Оружие", NAPI.Util.GetHashKey("w_pi_raygun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.0f, 2, 1) },
    { ItemId.CeramicPistol, new ItemsInfo("Керамический пистолет", "Керамический пистолет, обойма вмещает в себя 12 патронов.", "inv-item-Combat-Pistol", "Оружие", NAPI.Util.GetHashKey("w_pi_ceramic_pistol"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 0.9f, 2, 1) },
    { ItemId.NavyRevolver, new ItemsInfo("Военно-морской револьвер", "Стреляет патронами калибра .357 Magnum. Вы хотите знать, как был завоеван Запад - медленные скорости перезарядки и целая куча кровопролития.", "inv-item-Heavy-Revolver-Mk-II", "Оружие", NAPI.Util.GetHashKey("w_pi_wep2_gun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.3f, 3, 1) },
    ...
    // ========================================
    { ItemId.MicroSMG, new ItemsInfo("Микро ПП", "Стреляет патронами калибра .45ACP. Это известно как хорошее все вокруг пистолета - пулемета. Легкий с точным прицелом и емкостью магазина 30- го тура.", "inv-item-Micro-SMG", "Оружие", 3238253642, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.4f, 3, 2) },
    { ItemId.MachinePistol, new ItemsInfo("Малый ПП", "Стреляет патронами 9x19mm. Этот полностью автоматический барабан - малый барабан для вашего двухмоторного баса V8.", "inv-item-Machine-Pistol", "Оружие", 3963421467, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.0f, 3, 2) },
    { ItemId.SMG, new ItemsInfo("ПП", "Стреляет патронами калибра .45ACP. Это известно как хорошее все вокруг пистолета - пулемета. Легкий с точным прицелом и емкостью магазина 30- го тура.", "inv-item-SMG", "Оружие", 3794909300, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.8f, 2, 3) },
    { ItemId.AssaultSMG, new ItemsInfo("Штурмовой пистолет-пулемет", "Штурмовое автоматическое оружие.", "inv-item-Assault-SMG", "Оружие", 3821393119, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.0f, 2, 3) },
    { ItemId.CombatPDW, new ItemsInfo("Боевой ПОС", "Стреляет патронами калибра .45ACP. Гибридное оружие, в основном основанное на SIG MPX, но с различными отличиями.", "inv-item-Combat-PDW", "Оружие", 2901952492, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.9f, 4, 2) },
    { ItemId.MG, new ItemsInfo("Пулемёт Калашникова", "Стреляет патронами 7.62x39mm. Пулемет общего назначения, сочетающий в себе прочную конструкцию и надежную производительность.", "inv-item-MG", "Оружие", 2238602894, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 7.5f, 5, 2) },
    { ItemId.CombatMG, new ItemsInfo("Ручной пулемёт", "Стреляет патронами 5.56x45mm. Легкий, компактный пулемет, который сочетает в себе превосходную маневренность с высокой скорострельностью.", "inv-item-Combat-MG", "Оружие", 3555572849, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 6.1f, 5, 2) },
    { ItemId.Gusenberg, new ItemsInfo("Пистолет-пулемёт Томпсона", "Стреляет патронами калибра .45ACP. Выглядит замечательно, когда торчит из окна Рузвельта или в паре с полосатым костюмом.", "inv-item-Gusenberg-Sweeper", "Оружие", 574348740, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.6f, 4, 2) },
    { ItemId.MiniSMG, new ItemsInfo("Мини ПП", "Стреляет патронами 9x19mm. Растущая популярность, поскольку маркетинговая команда смотрела за пределы специальных подразделений.", "inv-item-Mini-SMG", "Оружие", 3322144245, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.5f, 3, 2) },
    { ItemId.SMGMk2, new ItemsInfo("ПП Mk2", "Стреляет патронами калибра .45ACP. Легкий, компактный, с высокой скорострельностью.", "inv-item-SMG-Mk-II", "Оружие", 2547423399, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.6f, 3, 2) },
    { ItemId.CombatMGMk2, new ItemsInfo("Ручной пулемет Мk2", "Стреляет патронами 5.56x45mm. Вы никогда не сможете получить слишком много хорошего", "inv-item-Combat-MG-Mk-II", "Оружие", 2969831089, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 5.7f, 5, 2) },

    // ========================================
    // ОРУЖИЕ БЛИЖНЕГО БОЯ (1x2 или 1x3, 0.3-2.5 кг)
    // ========================================
    { ItemId.Knife, new ItemsInfo("Охотничий нож", "Нож, оснащённый обоюдоострым зазубренным лезвием, обладает повышенной проникающей способностью.", "inv-item-Knife", "Оружие ближнего боя", 2312523967, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.18f, 1, 2) },
    { ItemId.Nightstick, new ItemsInfo("Польцейская дубинка", "Нашли нарушителя порядка? Пора воспользоваться дубинкой.", "inv-item-Nightstick", "Оружие ближнего боя", 2659989060, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.8f, 1, 3) },
    { ItemId.Hammer, new ItemsInfo("Молот", "Ударный инструмент, применяемый для забивания гвоздей, разбивания предметов и других работ.", "inv-item-Hammer", "Оружие ближнего боя", 64104227, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.3f, 1, 3) },
    { ItemId.Bat, new ItemsInfo("Бейсбольная бита", "Спортивный снаряд, которым игроки в некоторых спортивных играх пытаются отбить поданный мяч.", "inv-item-Baseball-Bat", "Оружие ближнего боя", 32653987, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 1.4f, 1, 4) },
    { ItemId.Crowbar, new ItemsInfo("Лом", "Усиленный лом, выкованный из высококачественной закаленной стали, для того дополнительного рычага, который необходим для выполнения работы.", "inv-item-crowbar", "Оружие ближнего боя", 1862268168, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 3.5f, 1, 4) },
    { ItemId.GolfClub, new ItemsInfo("Клюшка для гольфа", "Гольф-клюшка средней длины со средним железом, резиновой рукояткой для смертельной короткой игры.", "inv-item-Golf-Club", "Оружие ближнего боя", 3714771050, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 1.0f, 1, 4) },
    { ItemId.Bottle, new ItemsInfo("Разбитая бутылка", "Разбитая стеклянная бутылка, может использоваться для нанесения колющих ранений.", "inv-item-Broken-Bottle", "Оружие ближнего боя", 1150762982, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.25f, 1, 2) },
    { ItemId.Dagger, new ItemsInfo("Кинжал", "Коллекционный кинжал XIX века", "inv-item-Antique-Cavalry-Dagger", "Оружие ближнего боя", 601713565, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.6f, 1, 3) },
    { ItemId.Hatchet, new ItemsInfo("Топорик", "Рубящий инструмент с тяжелым металлическим лезвием, насаженным на длинную сменную рукоять.", "inv-item-Hatchet", "Оружие ближнего боя", 1653948529, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 1.8f, 2, 2) },
    { ItemId.KnuckleDuster, new ItemsInfo("Кастет", "Отличный помощник в уличных боях.", "inv-item-Brass-Knuckles", "Оружие ближнего боя", 3005998612, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 1.2f, 2, 4) },
    { ItemId.Machete, new ItemsInfo("Мачете", "Длинный, тонкий и широкий нож. Клинок с односторонней заточкой, выпуклым лезвием, иногда с загнутым к лезвию остриём.", "inv-item-Machete", "Оружие ближнего боя", 2239480765, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.7f, 1, 3) },
    { ItemId.Flashlight, new ItemsInfo("Фонарик", "Луч света в темноте.", "inv-item-Flashlight", "Оружие ближнего боя", 2278481040, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.35f, 2, 1) },
    { ItemId.SwitchBlade, new ItemsInfo("Клинок", "Складной нож, поможет вам в решении многих проблем.", "inv-item-Switchblade", "Оружие ближнего боя", 3331136096, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.2f, 1, 1) },
    { ItemId.PoolCue, new ItemsInfo("Бильярдный кий", "Отлично подойдет для игры в бильярд", "inv-item-Pool-Cue", "Оружие ближнего боя", 1184113278, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.7f, 1, 3) },
    { ItemId.Wrench, new ItemsInfo("Газовый ключ", "Разновидность разводного ключа, используемая для вращения или фиксации труб и других деталей произвольной формы.", "inv-item-Pipe-Wrench", "Оружие ближнего боя", 1959553115, 1, new Vector3(0.0,0.0,-0.985), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 0.1f, 1, 4) },
    { ItemId.BattleAxe, new ItemsInfo("Боевой топор", "Для средневековых пехотинцев, современных пограничников и отбитых на голову психов.", "inv-item-Battle-Axe", "Оружие ближнего боя", 3406411762, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons, "gray", 1.5f, 2, 4) },
        // ========================================
    // ОРУЖИЕ: ВИНТОВКИ (1x4, 3.0-4.5 кг)
    // ========================================
    { ItemId.AssaultRifle, new ItemsInfo("Штурмовая винтовка", "Стреляет патронами 7.62x39mm. Эта стандартная штурмовая винтовка может похвастаться магазином большой емкости и точностью на большие расстояния.", "inv-item-Assault-Rifle", "Оружие", 273925117, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.9f, 4, 2) },
    { ItemId.CarbineRifle, new ItemsInfo("Карабинная винтовка", "Стреляет патронами 5.56x45mm. Комбинируя точность на большом расстоянии с магазином большой емкости.", "inv-item-Carbine-Rifle", "Оружие", 1026431720, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.6f, 4, 2) },
    { ItemId.AdvancedRifle, new ItemsInfo("Усовершенствованная винтовка", "Усовершенствованная штурмовая винтовка, обойма вмещает в себя 30 патронов.", "inv-item-Advanced-Rifle", "Оружие", 2587382322, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.8f, 4, 2) },
    { ItemId.SpecialCarbine, new ItemsInfo("Специальный карабин", "Стреляет патронами 7.62x39mm. Чрезвычайно универсальная штурмовая винтовка для любой боевой ситуации.", "inv-item-Special-Carbine", "Оружие", 2549323539, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.7f, 4, 2) },
    { ItemId.BullpupRifle, new ItemsInfo("Винтовка Буллпап", "Стреляет патронами 5.56x45mm. Эта последняя винтовка Китая, взявшая Америку штурмом, известна своей сбалансированной управляемостью.", "inv-item-Bullpup-Rifle", "Оружие", 3006407723, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.5f, 4, 2) },
    { ItemId.CompactRifle, new ItemsInfo("Компактная винтовка", "Стреляет патронами 7.62x39mm. Половина размера, вся мощность, двойная отдача: нет более рискованного способа сказать« я что-то компенсирую.", "inv-item-Compact-Rifle", "Оружие", 1931114084, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 1.8f, 3, 2) },
    { ItemId.AssaultRifleMk2, new ItemsInfo("Штурмовая винтовка Mk2", "Стреляет патронами 7.62x39mm. Окончательный пересмотр классики на все времена: все, что нужно, это немного поработать, а внешний вид может убить в конце концов.", "inv-item-Assault-Rifle-Mk-II", "Оружие", 1762764713, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.9f, 4, 2) },
    { ItemId.CarbineRifleMk2, new ItemsInfo("Карабинная винтовка Mk2", "Стреляет патронами 5.56x45mm. Cделанная на заказ, огневая мощь, доставляет град пуль с большей любовью и заботой. Уникальное оружие LSPD", "inv-item-Carbine-Rifle-Mk-II", "Оружие", 1520780799, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.3f, 4, 2) },
    { ItemId.SpecialCarbineMk2, new ItemsInfo("Специальный карабин Mk2", "Стреляет патронами 7.62x39mm. Мастер на все руки только что получил серьезное повышение: поклонись хозяину.", "inv-item-Special-Carbine-Mk-II", "Оружие", 2379721761, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.0f, 4, 2) },
    { ItemId.BullpupRifleMk2, new ItemsInfo("Винтовка буллпап Mk2", "Стреляет патронами 5.56x45mm. Так точно, так изящно, это не столько град пуль, сколько симфония.", "inv-item-Bullpup-Rifle-Mk-II", "Оружие", 1415744902, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.5f, 1, 4) },
    { ItemId.MilitaryRifle, new ItemsInfo("Военная Винтовка", "Стреляет патронами 5.56x45mm. Мастер на все руки только что получил серьезное повышение: поклонись хозяину. Уникальное оружие SANG", "inv-item-militaryrifle", "Оружие", 1415744902, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.0f, 4, 2) },
    { ItemId.RayCarbine, new ItemsInfo("Рей карабин", "Футуристичная плазменная винтовка, имеет необычный внешний вид.", "NEEDTEXT", "Оружие", NAPI.Util.GetHashKey("w_ar_srifle"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.5f, 4, 2) },
    { ItemId.TacticalRifle, new ItemsInfo("Тактическая винтовка", "Стреляет патронами 5.56x45mm. Военная винтовка на базе M16; это гибрид, в основном основанный на раннем XM16E1 и современном M16A4.", "inv-item-militaryrifle", "Оружие", 273925117, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 2.2f, 4, 2) },
    { ItemId.HeavyRifle, new ItemsInfo("Тяжёлая винтовка", "Стреляет патронами 7.62x39mm. Эта стандартная штурмовая винтовка может похвастаться магазином большой емкости и точностью на большие расстояния.", "inv-item-militaryrifle", "Оружие", 2379721761, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.3f, 4, 2) },
    ...
    // ========================================
    { ItemId.SniperRifle, new ItemsInfo("Снайперская винтовка", "Стреляет патронами .50 BMG. Особенности бронебойных снарядов для тяжелых повреждений. В стандартную комплектацию входит лазерный прицел.", "inv-item-Sniper-Rifle", "Оружие", 346403307, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 6.5f, 5, 2) },
    { ItemId.HeavySniper, new ItemsInfo("Тяжелая снайперская винтовка","Стреляет патронами .50 BMG. Особенности бронебойных снарядов для тяжелых повреждений. В стандартную комплектацию входит лазерный прицел.", "inv-item-Heavy-Sniper", "Оружие", 3548001216, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 4.5f, 5, 2) },
    ...
    { ItemId.HeavySniperMk2, new ItemsInfo("Тяжелая снайперская винтовка Mk2", "Стреляет патронами .50 BMG. Особенности бронебойных снарядов для тяжелых повреждений. В стандартную комплектацию входит лазерный приц1л.", "inv-item-Heavy-Sniper-Mk-II", "Оружие", 619715967, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 8.0f, 5, 2) },
    { ItemId.MarksmanRifleMk2, new ItemsInfo("Винтовка Marksman Mk2", "Стреляет патронами 7.62x39mm. Известная в военных кругах как «Дислокатор», эта винтовка будет уничтожать всех противников. Уникальное оружие FIB", "inv-item-Marksman-Rifle-Mk-II", "Оружие", 2436666926, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 3.7f, 4, 2) },
    { ItemId.PrecisionRifle, new ItemsInfo("Прецизионная винтовка", "Стреляет патронами .50 BMG. Прецизионная винтовка без оптического прицела, которая, по-видимому, в значительной степени основана на улучшенной винтовке Remington 700 PCR.", "inv-item-militaryrifle", "Оружие", 346403307, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons, "gray", 4.0f, 5, 2) },
    ...
    // ========================================
// ✅ УНИВЕРСАЛЬНЫЕ МОДИФИКАЦИИ (БЕЗ ПРИВЯЗКИ К ОРУЖИЮ)
{ ItemId.cClip, new ItemsInfo("Увеличенный магазин", "Универсальный улучшенный магазин.", "inv-item-Clips", "Особое", NAPI.Util.GetHashKey("w_ar_assaultriflemk2_mag1"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.2f, 1, 1) },
{ ItemId.cClip2, new ItemsInfo("Магазин бронебойных патрон", "Универсальный улучшенный магазин.", "inv-item-Clips", "Особое", NAPI.Util.GetHashKey("w_ar_carbineriflemk2_mag_ap"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.2f, 1, 1) },
{ ItemId.cSuppressor, new ItemsInfo("Глушитель", "Универсальный глушитель.", "inv-item-Suppressors", "Особое", NAPI.Util.GetHashKey("w_at_ar_supp"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.3f, 1, 1) },
{ ItemId.cScope, new ItemsInfo("Оптический прицел", "Универсальный модуль подходящий к любому виду оружия. Оптический прибор, предназначенный для наводки оружия на цель от первого лица.   ", "inv-item-Scopes", "Особое", NAPI.Util.GetHashKey("w_at_scope_medium"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.25f, 1, 1) },
{ ItemId.cScope2, new ItemsInfo("Голографический прицел", "Универсальный модуль подходящий к любому виду оружия Mk2. Прицеливание с помощью голограммы в виде прицельной марки для наводки оружия на цель от первого лица.", "inv-item-Scopes", "Особое", NAPI.Util.GetHashKey("w_at_scope_medium"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.25f, 1, 1) },
{ ItemId.cFlashlight, new ItemsInfo("Фонарик на оружие", "Универсальный фонарик.", "inv-item-Flashlights", "Особое", NAPI.Util.GetHashKey("w_at_ar_flsh"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.15f, 1, 1) },
{ ItemId.cGrip, new ItemsInfo("Рукоятка", "Универсальная улучшенная рукоять.", "inv-item-Grips", "Особое", NAPI.Util.GetHashKey("w_at_afgrip_2"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification, "gray", 0.1f, 1, 1) },
